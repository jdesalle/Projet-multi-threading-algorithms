...
DEST=DEP/producer_consumer philosophe reader_writer
...
reader_writer:OBJ/reader_writer.c
	$(CC) -o reader_writer OBJ/reader_writer.c $(CFLAGS)
producer_consumer_sem:PERSO/producer_consumer_sem.c PERSO/my_semaphore.c PERSO/my_TnTnS.c  DEP/my_sempahore.h DEP/my_TnTnS.h
	$(CC) -o producer_consumer_sem  PERSO/producer_consumer_sem.c PERSO/my_semaphore.c PERSO/my_TnTnS.c  DEP/my_sempahore.h DEP/my_TnTnS.h $(CFLAGS)
reader_writer_sem:PERSO/reader_writer_sem.c PERSO/my_semaphore.c PERSO/my_TnTnS.c  DEP/my_sempahore.h DEP/my_TnTnS.h
	$(CC) -o reader_writer_sem PERSO/reader_writer_sem.c PERSO/my_semaphore.c PERSO/my_TnTnS.c  DEP/my_sempahore.h DEP/my_TnTnS.h $(CFLAGS)
